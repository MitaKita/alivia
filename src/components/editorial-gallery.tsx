      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px] md:auto-rows-[320px]">
          {MAKEUP_PHOTOS.map((photo) => (
            <div
              key={photo.id}
              className={`group relative overflow-hidden bg-zinc-900 border border-zinc-900/50 grayscale hover:grayscale-0 transition-all duration-700 ease-out ${photo.gridClass}`}
            >
